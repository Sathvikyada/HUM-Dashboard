...
- Set env in Netlify: ADMIN_API_SECRET, SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY, RESEND_API_KEY, EMAIL_FROM, GOOGLE_SHEETS_SPREADSHEET_ID, GOOGLE_SERVICE_ACCOUNT_EMAIL, GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY, EVENT_SLUG, BASE_APP_URL, VITE_NETLIFY_FUNCTIONS_BASE (optional)
